...
export const UpdateMaintenance: React.FC = () => {
  const { updateMaintenance, maintenanceSelected } = useMaintenances();
  const history = useHistory();
  const onSend = (event: any) => {
    if (maintenanceSelected?.id) {
      updateMaintenance(
        {
          ...event,
...
*/
  ...
  const [fields, setFields] = useState([
    {
      name: ["nombre_taller"],
      value: maintenanceSelected?.nombre_taller,
    },
    {
      name: ["nro_proforma"],
      value: maintenanceSelected?.nro_proforma,
    },
    {
      name: ["nro_factura"],
      value: maintenanceSelected?.nro_factura,
    },
    {
      name: ["fecha_emision"],
      value: moment(maintenanceSelected?.fecha_emision || undefined),
    },
    {
      name: ["fecha_salida"],
      value: moment(maintenanceSelected?.fecha_salida || undefined),
    },
    {
      name: ["observaciones"],
      value: maintenanceSelected?.observaciones,
    },
    {
      name: ["detalle"],
      value: maintenanceSelected?.detalle,
    },
  ]);
  return (
    <Paper>
      <h1>Actualiza los Datos del Registro de Mantenimiento</h1>
      <Form
        name="basic"
        layout="vertical"
        initialValues={{
